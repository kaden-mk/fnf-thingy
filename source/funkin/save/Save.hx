    ...
    var newScore:SaveScoreData =
      {
        ...
        accuracy: (previousScoreData.accuracy > newScoreData.accuracy) ? previousScoreData.accuracy : newScoreData.accuracy,
      };
...
typedef SaveDataOptions =
{
  ...
  /**
   * Whether the health bar ui is visible.
   * @default `true`
   */
  var healthbar:Bool;
  ...
  /**
   * Whether the combo number is visible.
   * @default `true`
   */
  var comboNumber:Bool;

  /**
   * Whether the rating from hitting a note is visible.
   * @default `true`
   */
  var rating:Bool;

  /**
   * Whether the notes from the opponent is visible.
   * @default `true`
   */
  var oppNotes:Bool;

  /**
   * Whether the score under the heatlh bar ui is visible.
   * @default `true`
   */
  var score:Bool;
  ...
  /**
   * If enabled, there will be note splashes when hitting a note with the sick score.
   * @default `true`
   */
